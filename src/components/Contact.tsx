...
export function Contact() {
  ...
  const contactInfo = [
    { icon: Mail, label: "Email", value: "shaikasif2026@gmail.com" },
    { icon: Phone, label: "Phone", value: "+91 9618720325" },
    { icon: MapPin, label: "Location", value: "Hyderabad, Telangana, India" },
  ];

  const quickLinks = [
    { icon: Github, url: "https://github.com/shaik-asif967" },
    { icon: Linkedin, url: "https://www.linkedin.com" },
    { icon: Mail, url: "mailto:shaikasif2026@gmail.com" },
    { icon: MessageCircle, url: "https://wa.me/+919618720325" },
    { icon: Instagram, url: "https://www.instagram.com/asif___shaik__369/" },
  ];
