  ...
  return (
    <section id="resume" className="resume-section">
      <div className="resume-container">
        ...
        >
          <a href="/Shaik_Asif_Final_Resume.pdf" download className="download-btn">
            <Download size={20} />
            Download Resume
          </a>
        </motion.div>
        ...
        >
          ...
          >
            ...
            📩 shaikasif2026@gmail.com | 📱 +91 9618720325
          </motion.p>
            ...
            {[
              {
                ...
                school: "IARE — Institute Of Aeronautical Engineering, Hyderabad",
                period: "2023 – 2027",
                detail: "Current GPA: 7.79",
              },
              {
              ...
              },
              {
                ...
                school: "Sri Kakathiya High School",
                period: "2020 – 2021",
                detail: "100%",
              },
            ].map((edu, i) => (
