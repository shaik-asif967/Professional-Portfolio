...
export function FloatingNav() {
  const socialLinks = [
    { icon: Github, href: 'https://github.com/shaik-asif967', label: 'GitHub' },
    { icon: Linkedin, href: 'https://www.linkedin.com', label: 'LinkedIn' },
    { icon: Twitter, href: '#', label: 'Twitter' },
    { icon: Instagram, href: 'https://www.instagram.com/asif___shaik__369/', label: 'Instagram' },
    { 
      icon: () => (
      ...
      href: 'https://leetcode.com/u/shaikasif369/', 
      label: 'LeetCode' 
    },
    { icon: Mail, href: 'mailto:shaikasif2026@gmail.com', label: 'Email' },
  ];
