...
export function Home({ theme }: HeroProps) {
  ...
  const connectLinks = [
    { img: linkedinLogo, link: "https://www.linkedin.com" },
    { img: gmailLogo, link: "mailto:shaikasif2026@gmail.com" },
    { img: whatsappLogo, link: "https://wa.me/+919618720325" },
    { img: instagramLogo, link: "https://www.instagram.com/asif___shaik__369/" },
    { img: facebookLogo, link: "https://www.facebook.com/shaikasif369" },
  ];

  const workLinks = [
    { img: githubLogo, link: "https://github.com/shaik-asif967" },
    { img: leetcodeLogo, link: "https://leetcode.com/u/shaikasif369/" },
  ];
    ...
    <section id="home" className="hero">
      ...
      <motion.div className="hero-content" variants={containerVariants} initial="hidden" animate="visible">
        <motion.h1 className="hero-name" variants={itemVariants}>
          Hi! I’m <br />
          <span className="gradient-text hero-name-line">Shaik Asif</span>
        ...
        <motion.div className="hero-info" variants={itemVariants}>
          {[
            ...
            { label: "📞 Contact", value: "shaikasif2026@gmail.com" },
          ].map((info, i) => (
